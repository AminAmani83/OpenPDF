...
//    [M3] Images
    ...
    public float getImageEnd() {
        return imageEnd;
    }

    public void setImageEnd(float imageEnd) {
    ...
    public Image getImageWait() {
        return imageWait;
    }

    public void setImageWait(Image imageWait) {
